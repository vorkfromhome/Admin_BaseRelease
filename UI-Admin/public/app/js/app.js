        ...
        function activate() {
            ...
            vm.login = function () {
               ...
               console.log(vm.account.email);
                 console.log(vm.account.password);
                if (vm.loginForm.$valid) {
                    $http.post('http://localhost:3000/api/usermanagements/loginuser', {
                 ...
                 console.log(vm.account.password);
                          if (response.data[0]=="1" ) {
                            ...
                            vm.authMsg = 'Please Check Your Details Properly!';
                        }
                    }, function () {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider.state('app', {
            ...
            .state('page', {
                ...
                url: '/material'
                , title: 'material'
                , templateUrl: helper.basepath('material.html')
                ...
                url: '/metrics'
                , title: 'metrics'
                , templateUrl: helper.basepath('metrics.html')
                ...
                url: '/attribute'
                , title: 'attribute'
                , templateUrl: helper.basepath('attribute.html')
...
(function () {
    ...
    function metricsController($scope, $http, $state, $location, SweetAlert, ngDialog) {
        var vm = this;
        vm.submitted = false;
        ...
        vm.editmetrics = function (id) {
            ...
            $http.get("http://localhost:3000/api/metrics/listmetricone?id=" + id + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                $scope.setdatatoo = vm.setdata[0];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                console.log($scope.setdatatoo._id);
               if ($scope.setdatatoo._id == undefined) {
                    $http.get("http://localhost:3000/api/metrics/createmetric?name=" + $scope.setdatatoo.name + "&symbol=" + $scope.setdatatoo.symbol + "&baseunit=" + $scope.setdatatoo.baseunit + "&multiple=" + $scope.setdatatoo.multiple + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
                    });
                }
                else {
                    $http.get("http://localhost:3000/api/metrics/updatemetric?name=" + $scope.setdatatoo.name + "&symbol=" + $scope.setdatatoo.symbol + "&baseunit=" + $scope.setdatatoo.baseunit + "&multiple=" + $scope.setdatatoo.multiple + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&id=" + $scope.setdatatoo._id + "&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
...
(function () {
    ...
    function userController($scope, $http, $state, $location, SweetAlert, ngDialog) {
        var vm = this;
        vm.submitted = false;
        ...
        vm.producttitle = "User Management";
        vm.modifyby = "admin";
        vm.modifyon = "current date";
        vm.disabled = '';
        vm.showpwd = true;
        ...
        vm.edituser = function (id) {
            vm.showpwd = false;
            vm.disabled = 'disabled="disabled"';
            vm.producttitle = "Update User Management";
            $http.get("http://localhost:3000/api/usermanagements/listuserone?id=" + id + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                $scope.setdatatoo = vm.setdata[0];

                ngDialog.openConfirm({
                    template: 'modalDialogIdupdate'
                    , className: 'ngdialog-theme-default'
                    , scope: $scope
                }).then(function (value) {
                    console.log('Modal promise resolved. Value: ', value);
        ...
        //resetuser
          ...
          vm.resetuser= function(id) {
             SweetAlert.swal({
                title: 'Are you sure?'
                , text: 'you want to be rest the password!'
                , type: 'warning'
                , showCancelButton: true
                , confirmButtonColor: '#DD6B55'
                ...
                if (isConfirm) {
                    $http.get("http://localhost:3000/api/usermanagements/resetuser?status=1&id=" + id + "&modifiedby=admin&access_token=metricmangement").then(function (response) {
                        var index = -1;
                        for (var i = 0; i < vm.productdata.length; i++) {
                            if (vm.productdata[i]._id === id) {
                                vm.productdata[i].activestatus="2";
                                index = i;
                                break;
                            }
                        }
                        ...
                        SweetAlert.swal('Password Reseted!', 'Your file has been deleted.', 'success');
                    });
                }
                else {
                    SweetAlert.swal('Cancelled', 'Your file is safe :)', 'error');
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                ...
                console.log($scope.setdatatoo._id);
               if ($scope.setdatatoo._id == undefined) {
                    $http.get("http://localhost:3000/api/usermanagements/createuser?firstname=" + $scope.setdatatoo.firstname + "&lastname=" + $scope.setdatatoo.lastname + "&mobile=" + $scope.setdatatoo.mobile + "&email=" + $scope.setdatatoo.email + "&password=" + $scope.setdatatoo.password + "&pin=" + $scope.setdatatoo.pin + "&activestatus=" + $scope.setdatatoo.activestatus + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
                    ...
                    $http.get("http://localhost:3000/api/usermanagements/updateuser?firstname=" + $scope.setdatatoo.firstname + "&lastname=" + $scope.setdatatoo.lastname + "&mobile=" + $scope.setdatatoo.mobile + "&email=" + $scope.setdatatoo.email + "&password=" + $scope.setdatatoo.password + "&pin=" + $scope.setdatatoo.pin + "&activestatus=" + $scope.setdatatoo.activestatus + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&id=" + $scope.setdatatoo._id +  "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
...
(function () {
    'use strict';
    angular.module('app.filetobeupload').controller('materialController', materialController);
    // materialController.$inject = ['SweetAlert'];
    function materialController($scope, $http, $state, $location, SweetAlert, ngDialog) {
        var vm = this;
        vm.submitted = false;
        ...
        vm.bulkadd = function () {
            ngDialog.openConfirm({
                    template: 'bulkcreatemodalDialogId'
                    , className: 'ngdialog-theme-default'
                    , scope: $scope
                }).then(function (value) {
                    console.log('Modal promise resolved. Value: ', value);
        ...
        vm.bulkupdate = function () {
            ngDialog.openConfirm({
                    template: 'bulkupdatemodalDialogId'
                    , className: 'ngdialog-theme-default'
                    , scope: $scope
                }).then(function (value) {
                    console.log('Modal promise resolved. Value: ', value);
        ...
        $scope.uploadcreateFile = function () {
        ...
        vm.editmaterial = function (id) {
            ...
            $http.get("http://localhost:3000/api/materials/listmaterialone?id=" + id + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                $scope.setdatatoo = vm.setdata[0];
                ngDialog.openConfirm({
                    template: 'modalDialogId'
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                ...
                console.log($scope.setdatatoo._id);
               if ($scope.setdatatoo._id == undefined) {
                     $http.get("http://localhost:3000/api/materials/creatematerial?materialname=" + $scope.setdatatoo.name + "&category=" + $scope.setdatatoo.category + "&defaultmetric=" + $scope.setdatatoo.defaultmetrics + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
                    ...
                    $http.get("http://localhost:3000/api/materials/updatematerial?materialname=" + $scope.setdatatoo.name + "&category=" + $scope.setdatatoo.category + "&defaultmetric=" + $scope.setdatatoo.defaultmetrics + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&id=" + $scope.setdatatoo._id + "&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
...
(function () {
    'use strict';
    angular.module('app.filetobeupload').controller('attributeController', attributeController);

    function attributeController($scope, $http, $state, $location, SweetAlert, ngDialog) {
        var vm = this;
        vm.submitted = false;
            ...
            $http.post(uploadUrl, fd, {
                ...
                if (response.data.result.length != 0) {
                    ...
                    $http.get("http://localhost:3000/api/attributes/bulkcreateattribute?bulkdata=" + dataresult + "&totlen=0&access_token=metricmangement").then(function (response) {
                        console.log(response.data);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Error Rows - '+response.data, 'success');
                    });
                }
            });
        };
        ...
        vm.editattribute = function (id) {
            ...
            vm.disabled = 'disabled="disabled"';
            vm.producttitle = "Update User Management";
            $http.get("http://localhost:3000/api/attributes/listattributeone?id=" + id + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                $scope.setdatatoo = vm.setdata[0];
                ngDialog.openConfirm({
                    template: 'modalDialogId'
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                ...
                console.log($scope.setdatatoo._id);
               if ($scope.setdatatoo._id == undefined) {
                     $http.get("http://localhost:3000/api/attributes/createattribute?attributegrandparent=" + $scope.setdatatoo.attributegrandparent + "&attributerole=" + $scope.setdatatoo.attributerole + "&attributeparent=" + $scope.setdatatoo.attributeparent + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
                    ...
                    $http.get("http://localhost:3000/api/attributes/updateattribute?attributegrandparent=" + $scope.setdatatoo.attributegrandparent + "&attributerole=" + $scope.setdatatoo.attributerole + "&attributeparent=" + $scope.setdatatoo.attributeparent + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&activestatus=" + $scope.setdatatoo.activestatus + "&id=" + $scope.setdatatoo._id + "&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
...
// validation for clientController.........
(function () {
    'use strict';
    angular.module('app.dashboard').controller('clientController', clientController);

    function clientController($scope, $http, $state, $location, SweetAlert, ngDialog) {
        var vm = this;
        vm.submitted = false;
        ...
        vm.producttitle = "Client Management";
        vm.modifyby = "admin";
        vm.modifyon = "current date";
        vm.disabled = '';
        vm.showpwd = true;
        ...
        vm.editclient = function (id) {
            vm.showpwd = false;
            vm.disabled = 'disabled="disabled"';
            vm.producttitle = "Update Client Management";
            $http.get("http://localhost:3000/api/clients/listclientone?id=" + id + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                $scope.setdatatoo = vm.setdata[0];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                ...
                console.log($scope.setdatatoo._id);
               if ($scope.setdatatoo._id == undefined) {
                     $http.get("http://localhost:3000/api/clients/createclient?firstname=" + $scope.setdatatoo.firstname + "&lastname=" + $scope.setdatatoo.lastname + "&mobile=" + $scope.setdatatoo.mobile + "&email=" + $scope.setdatatoo.email + "&password=" + $scope.setdatatoo.password + "&pin=" + $scope.setdatatoo.pin + "&activestatus=" + $scope.setdatatoo.activestatus + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
                    ...
                    $http.get("http://localhost:3000/api/clients/updateclient?firstname=" + $scope.setdatatoo.firstname + "&lastname=" + $scope.setdatatoo.lastname + "&mobile=" + $scope.setdatatoo.mobile + "&email=" + $scope.setdatatoo.email + "&password=" + $scope.setdatatoo.password + "&pin=" + $scope.setdatatoo.pin + "&activestatus=" + $scope.setdatatoo.activestatus + "&modifiedon=" + vm.modifyon + "&modifiedby=" + vm.modifyby + "&id=" + $scope.setdatatoo._id +  "&status=1&access_token=metricmangement").then(function (response) {
                        console.log(response.data[0]);
                        ngDialog.close();
                        SweetAlert.swal('Successfully!', 'Your file has been deleted.', 'success');
                        activate();
        ...
        $scope.openConfirm = function () {
           ...
           vm.resetclient= function(id) {
             SweetAlert.swal({
                ...
                if (isConfirm) {
                    $http.get("http://localhost:3000/api/clients/resetclient?status=1&id=" + id + "&modifiedby=admin&access_token=metricmangement").then(function (response) {
                        var index = -1;
                        for (var i = 0; i < vm.productdata.length; i++) {
                            if (vm.productdata[i]._id === id) {
                                vm.productdata[i].activestatus="2";
        ...
        vm.deleterow = function (id) {
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    $http.get("http://localhost:3000/api/clients/deleteclient?status=0&id=" + id + "&modifiedby=admin&access_token=metricmangement").then(function (response) {
                        var index = -1;
                        var comArr = eval(vm.productdata);
                        for (var i = 0; i < comArr.length; i++) {
                            if (comArr[i]._id === id) {
        ...
        function activate() {
            $http.get("http://localhost:3000/api/clients/listclient?status=1&access_token=metricmangement").then(function (response) {
                console.log(response.data[0]);
                vm.productdata = response.data[0];
            });
        }
...
(function () {
    'use strict';
    angular.module('app.forms').controller('LoginController', LoginController);

    function LoginController($scope, $http, $state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                vm.authMsg = '';
                     $http.post("http://localhost:3000/api/usermanagements/loginuser?email="+vm.email+"&password=" + vm.password)
                         .then(function (response) {
                          if (response.data[0]=="1" ) {
                              $state.go('app.dashboard');
                              console.log(response.data[0]);
